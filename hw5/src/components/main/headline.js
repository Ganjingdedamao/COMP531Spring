    ...
    <div className="width_150 sidebar-module sidebar-module-inset align_center">  
      <div className="thumbnail margin_top_10">
        ...
        <div className="caption">
          ...
          <h5 className="margin_top_10" ><span className="glyphicon glyphicon-pencil"></span> {profile.headline}</h5>
          ...
          <button className="btn btn-success float_right " onClick={ _update }>Update</button>
          <br/><br/>
        </div>
      </div>
    </div>
